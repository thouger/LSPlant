...
#define _page_align(n)            _align_up(static_cast<size_t>(n), _page_size)
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_sysm_LSPTest_initHooker(JNIEnv*, jclass) {
    return init_result;
}

extern "C" JNIEXPORT jobject JNICALL Java_com_sysm_Hooker_doHook(JNIEnv* env, jobject thiz, jobject target, jobject callback) {
    return lsplant::Hook(env, target, thiz, callback);
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_sysm_Hooker_doUnhook(JNIEnv* env, jobject, jobject target) {
